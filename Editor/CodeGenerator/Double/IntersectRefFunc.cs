...
{
    public sealed class IntersectRefFunc : IApiExtensionMethodGenerator, ITypeDictionaryHolder
    {
        public readonly IDoubleApi Api;
        public IntersectRefFunc(IDoubleApi api) => Api = api;
        ...
        public void Generate(IEnumerableCollectionProcessor processor, ModuleDefinition mainModule, ModuleDefinition systemModule, ModuleDefinition unityModule)
        {
            ...
            mainModule.Types.Add(@static = mainModule.DefineStatic(nameof(IntersectRefFunc) + "Helper"));
            var count = Api.Count;
