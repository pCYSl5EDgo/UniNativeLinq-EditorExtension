...
{
    public sealed class IntersectFunc : IApiExtensionMethodGenerator, ITypeDictionaryHolder
    {
        public readonly IDoubleApi Api;
        public IntersectFunc(IDoubleApi api) => Api = api;
        ...
        public void Generate(IEnumerableCollectionProcessor processor, ModuleDefinition mainModule, ModuleDefinition systemModule, ModuleDefinition unityModule)
        {
            ...
            mainModule.Types.Add(@static = mainModule.DefineStatic(nameof(IntersectFunc) + "Helper"));
            var count = Api.Count;
