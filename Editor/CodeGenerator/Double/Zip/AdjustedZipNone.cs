...
{
    public sealed class AdjustedZipNone : IApiExtensionMethodGenerator, ITypeDictionaryHolder
    {
        public readonly IDoubleApi Api;
        public AdjustedZipNone(IDoubleApi api) => Api = api;
        ...
        public void Generate(IEnumerableCollectionProcessor processor, ModuleDefinition mainModule, ModuleDefinition systemModule, ModuleDefinition unityModule)
        {
            ...
            mainModule.Types.Add(@static = mainModule.DefineStatic(nameof(AdjustedZipNone) + "Helper"));
            var count = Api.Count;
