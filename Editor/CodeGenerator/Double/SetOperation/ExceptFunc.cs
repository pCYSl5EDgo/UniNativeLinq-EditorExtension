...
namespace UniNativeLinq.Editor.CodeGenerator
{
    public sealed class ExceptFunc : IApiExtensionMethodGenerator, ITypeDictionaryHolder
    {
        ...
        private void GenerateSpecialNormal(string specialName, TypeReference type, ModuleDefinition mainModule, ModuleDefinition systemModule, MethodDefinition method, int specialIndex)
        {
            var T = DefineT(method);
            var TComparer = DefineTComparer(mainModule, T);
            var body = method.Body;
