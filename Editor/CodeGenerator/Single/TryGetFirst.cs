...
namespace UniNativeLinq.Editor.CodeGenerator
{
    public sealed class TryGetFirst : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        ...
        private void GenerateNormal(MethodDefinition method, GenericParameter genericParameter, TypeReference enumerable, TypeReference enumerator)
        {
        ...
        private void GenerateNormalCanFastCount(MethodDefinition method, GenericParameter genericParameter, TypeReference enumerable, TypeReference enumerator)
        {
