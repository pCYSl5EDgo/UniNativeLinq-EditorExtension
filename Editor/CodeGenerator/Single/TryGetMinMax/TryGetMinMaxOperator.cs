...
namespace UniNativeLinq.Editor.CodeGenerator
{
    public sealed class TryGetMinMaxOperator : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        ...
        private void GenerateNativeArray(ModuleDefinition mainModule, MethodDefinition method, TypeReference returnTypeReference, TypeReference baseEnumerable, TypeReference T, TypeReference TOperator, MethodReference Calc)
        {
        ...
        private void GenerateArray(ModuleDefinition mainModule, MethodDefinition method, TypeReference returnTypeReference, TypeReference baseEnumerable, TypeReference T, TypeReference TOperator, MethodReference Calc)
        {
        ...
        private void GenerateNormal(MethodDefinition method, TypeDefinition type, TypeReference returnTypeReference, TypeReference T, TypeReference TOperator, MethodReference Calc)
        {
