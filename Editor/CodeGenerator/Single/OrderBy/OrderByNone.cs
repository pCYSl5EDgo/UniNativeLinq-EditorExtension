...
{
    public sealed class OrderByNone : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        ...
        private static void GenerateNormal(MethodDefinition method, TypeReference enumerable, GenericInstanceType comparer)
        {
