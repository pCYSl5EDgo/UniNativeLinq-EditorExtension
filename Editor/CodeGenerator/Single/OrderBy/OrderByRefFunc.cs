...
{
    public sealed class OrderByRefFunc : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        public OrderByRefFunc(ISingleApi api)
        {
            Api = api;
        }
        ...
        private void GenerateEach(string name, bool isSpecial, TypeDefinition @static, ModuleDefinition mainModule, ModuleDefinition systemModule)
        {
            ...
            var Func = new GenericInstanceType(mainModule.GetType("UniNativeLinq", "RefFunc`3"))
            {
