...
{
    public sealed class GroupByFunc2DefaultEqualityComparer : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        public GroupByFunc2DefaultEqualityComparer(ISingleApi api)
        {
            Api = api;
        }
