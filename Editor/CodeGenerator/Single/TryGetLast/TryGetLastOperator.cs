...
namespace UniNativeLinq.Editor.CodeGenerator
{
    public sealed class TryGetLastOperator : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        ...
        private static void GenerateCanIndexAccess(MethodDefinition method, TypeReference enumerable, TypeReference TPredicate, TypeReference predicate, TypeReference T)
        {
            var body = method.Body;
            body.InitLocals = true;
