...
namespace UniNativeLinq.Editor.CodeGenerator
{
    public sealed class AnyOperator : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        ...
        public void Generate(IEnumerableCollectionProcessor processor, ModuleDefinition mainModule, ModuleDefinition systemModule, ModuleDefinition unityModule)
        {
            ...
            mainModule.Types.Add(@static = mainModule.DefineStatic(nameof(AnyOperator) + "Helper"));
        ...
        private void GenerateNativeArray(MethodDefinition method, GenericParameter TOperator, GenericInstanceType IRefFunc2, (TypeReference baseEnumerable, GenericInstanceType specialEnumerable, GenericInstanceType specialEnumerator) tuple)
        {
        ...
        private void GenerateArray(ModuleDefinition mainModule, MethodDefinition method, GenericParameter TOperator, GenericParameter T, GenericInstanceType IRefFunc2, (TypeReference baseEnumerable, GenericInstanceType specialEnumerable, GenericInstanceType specialEnumerator) makeSpecialTypePair)
        {
        ...
        private void GenerateNormal(MethodDefinition method, TypeDefinition type, TypeReference TOperator, TypeReference T, TypeReference IRefFunc2)
        {
