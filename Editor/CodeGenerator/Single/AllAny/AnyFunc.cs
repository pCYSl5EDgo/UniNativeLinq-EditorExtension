...
{
    public sealed class AnyFunc : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        private const bool IsAll = false;
        public AnyFunc(ISingleApi api)
        {
            Api = api;
        }
        ...
        public void Generate(IEnumerableCollectionProcessor processor, ModuleDefinition mainModule, ModuleDefinition systemModule, ModuleDefinition unityModule)
        {
            ...
            mainModule.Types.Add(@static = mainModule.DefineStatic(nameof(AnyFunc) + "Helper"));
