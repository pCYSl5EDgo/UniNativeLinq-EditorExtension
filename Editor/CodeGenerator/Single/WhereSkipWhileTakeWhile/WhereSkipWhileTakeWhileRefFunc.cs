...
{
    public sealed class WhereSkipWhileTakeWhileRefFunc : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        public WhereSkipWhileTakeWhileRefFunc(ISingleApi api)
        {
            Api = api;
        }
