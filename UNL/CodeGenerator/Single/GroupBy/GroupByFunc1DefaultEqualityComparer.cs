...
{
    public sealed class GroupByFunc1DefaultEqualityComparer : ITypeDictionaryHolder, IApiExtensionMethodGenerator
    {
        public GroupByFunc1DefaultEqualityComparer(ISingleApi api)
        {
            Api = api;
        }
