...
namespace pcysl5edgo.Collections.LINQ
{
...
#endif
    {
        ...
        {
            private NativeEnumerable<T> Parent;
            private int index;
            public ref T Current => ref Parent.array.ElementAt(index);
            T IEnumerator<T>.Current => Current;
            object IEnumerator.Current => Current;
            ref T IRefEnumerator<T>.Current => ref Current;
            ...
            public bool MoveNext() => Parent.array.IsCreated && ++index < Parent.array.Length;
