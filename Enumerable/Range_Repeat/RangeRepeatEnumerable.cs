...
namespace pcysl5edgo.Collections.LINQ
{
        ...
        where TAction : struct, IRefAction<TSource>
    {
        ...
        public
            ...
            >
            Skip(long count)
            => new WhereIndexEnumerable<RangeRepeatEnumerable<TSource, TAction>, Enumerator, TSource, DefaultSkipIndex<TSource>>(this, new DefaultSkipIndex<TSource>(count));
        ...
        public
            ...
            => new WhereIndexEnumerable<RangeRepeatEnumerable<TSource, TAction>, Enumerator, TSource, DefaultSkipWhileIndex<TSource, TPredicate0>>(this, new DefaultSkipWhileIndex<TSource, TPredicate0>(predicate));
        ...
        public
            ...
            >
            Take(long count)
            => new WhereIndexEnumerable<RangeRepeatEnumerable<TSource, TAction>, Enumerator, TSource, DefaultTakeIndex<TSource>>(this, new DefaultTakeIndex<TSource>(count));
        ...
        public
            ...
            where TPredicate0 : struct, IWhereIndex<TSource>
            => new WhereIndexEnumerable<RangeRepeatEnumerable<TSource, TAction>, Enumerator, TSource, DefaultTakeWhileIndex<TSource, TPredicate0>>(this, new DefaultTakeWhileIndex<TSource, TPredicate0>(predicate));
        ...
        public WhereIndexEnumerable<
            ...
            where TPredicate0 : struct, IWhereIndex<TSource>
            => new WhereIndexEnumerable<RangeRepeatEnumerable<TSource, TAction>, Enumerator, TSource, TPredicate0>(this, predicate);
        ...
        public ConcatEnumerable<
            ...
            => new ConcatEnumerable<RangeRepeatEnumerable<TSource, TAction>, Enumerator, WhereIndexEnumerable<TPrevEnumerable0, TPrevEnumerator0, TSource, TPredicate>, WhereIndexEnumerable<TPrevEnumerable0, TPrevEnumerator0, TSource, TPredicate>.Enumerator, TSource>(this, second);
